        ...
        methods: [
          {
            ...
            purpose: '⭐ <code>private</code>! ما أحد يقدر يسوي <code>new Car()</code> مباشرة. يستقبل الـ Builder وينسخ منه كل القيم. هذا اللي يجبر الكلاينت يستخدم Builder.',
            code: 'private Car(Builder builder) {\n    this.make = builder.make;\n    this.model = builder.model;\n    this.radio = builder.radio;\n}'
          },
          {
            name: 'public static class Builder',
            purpose: '⭐⭐⭐ inner static class اسمها Builder. لاحظ <code>static</code>! لازم تكون <code>static</code> عشان نقدر نسوي <code>new Car.Builder(...)</code> بدون ما نحتاج Car object أولاً.',
      ...
      },
      {
        ...
        methods: [
          ...
          },
          {
            ...
            purpose: '⭐ method اختيارية. لاحظ تنتهي بـ <code>return this;</code> هذا اللي يخلي method chaining شغال: <code>builder.withRadio().withGPS().build()</code>',
            code: 'public Builder withRadio() {\n    this.radio = new Radio();\n    return this;\n}'
          },
          {
            name: 'public Car build()',
            purpose: 'الـ method النهائية. تنشئ Car جديد وتمرر <code>this</code> (الـ Builder الحالي) للـ constructor.',
    ...
    public void draw();
      ...
      },
      {
        ...
        methods: [
          {
            name: 'public void draw()',
            purpose: 'كل نوع شكل ينفذ <code>draw()</code> بشكل مختلف. الـ Factory ترجع واحد منهم.',
        ...
        methods: [
          {
            ...
            purpose: '⭐⭐⭐ Factory method. تأخذ string وتقارنها بـ <code>equalsIgnoreCase</code> (مهم! غير حساس لحالة الأحرف). كل if يرجع نوع مختلف. هذا اللي يخفي تعقيد الإنشاء عن الكلاينت.',
    ...
    classes: [
      {
        ...
        desc: 'الـ interface اللي الكود حقي يحتاجها. الكود يريد للـ lat/lng بس الـ adaptee يأخذ city.',
        methods: [
          {
