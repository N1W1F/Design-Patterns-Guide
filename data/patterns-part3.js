    ...
    public abstract String getDescription();
      ...
      },
      {
        ...
        methods: [
          ...
          {
            name: 'public double cost()',
            purpose: '⭐⭐⭐ يضيف سعره (0.10) + سعر الـ sandwich اللي تحت. لاحظ <code>+ sandwich.cost()</code> — هذا اللي يخلي الأسعار تتراكم.',
    ...
    classes: [
      {
        ...
        methods: [
          ...
          },
          {
            ...
            purpose: 'الـ constructor يأخذ الحرف. لاحظ: لا ننشئ <code>new Glyph</code> من برّا — الـ Factory هو اللي ينشئها.',
        ...
        methods: [
          {
            ...
            purpose: '⭐ الـ <code>HashMap</code> اللي يخزن الـ flyweights. المفتاح <code>Character</code> والقيمة glyph. هذا اللي يضمن إن كل حرف له glyph واحد فقط.',
    ...
    public String getWeather(String city) {
      ...
      },
      {
        ...
        methods: [
          ...
          {
            name: 'public String getWeather(String city)',
            purpose: '⭐⭐⭐ القلب. أولاً يفحص API key، لو صحيح يفوض للـ Real، لو غلط يرجع <code>null</code>. هذا التحكم بالوصول.',
