...
const PATTERNS_DATA = {
  ...
  singleton: {
    id: 'singleton',
    name: 'Singleton',
    nameAr: 'النموذج المُفرد',
    icon: '01',
    category: 'Creational',
    categoryAr: 'إنشائي',
    color: 'var(--p-singleton)',
    tagline: 'نسخة واحدة فقط من الكائن في كامل التطبيق',
    ...
    <ol style="padding-inline-start: 1.5rem; margin-top: 0.5rem;">
        ...
        methods: [
          {
            ...
            purpose: 'حقل ساكن (<code>static</code>) يحفظ النسخة الوحيدة من الكلاس. لما يكون <code>static</code> يصبح مشترك بين كل الكلاس وليس لكل <code>object</code>. ولما يكون <code>private</code>، لا أحد يقدر يعدله من برّا.',
            code: 'private static DBConnection uniqueInstance;'
          },
          {
            name: 'private DBConnection()',
            purpose: 'الـ constructor خاص (<code>private</code>)! هذي أهم نقطة. السبب: لو تركناه <code>public</code>، أي شخص يقدر يكتب <code>new DBConnection()</code> ويكسر فكرة الـ Singleton. لما يكون <code>private</code>، الكلاس نفسه فقط يقدر ينشئ النسخ.',
            code: 'private DBConnection() {\n    // initialization code\n}'
          },
          {
            name: 'public static DBConnection getInstance()',
            purpose: 'الطريقة الوحيدة للحصول على النسخة. أول مرة تفحص إذا كان <code>uniqueInstance == null</code>، تنشئها. كل المرات اللي بعدها ترجع نفس النسخة. هذا اللي يضمن إن في نسخة وحدة فقط.',
    ...
    public static DBConnection getInstance() {
      ...
      },
      {
        ...
        methods: [
          {
            name: 'main()',
            purpose: 'ينشئ مرتين instance ويقارنهم بـ <code>==</code>. لو <code>==</code> رجعت <code>true</code> يعني نفس الـ object في الذاكرة (نجح الـ Singleton). لاحظ: لا نستخدم <code>new</code>، بل <code>getInstance()</code>.',
    ...
    classes: [
      {
        ...
        methods: [
          ...
          },
          {
            ...
            purpose: 'الـ method الأساسية في Prototype! <code>abstract</code> لأن كل subclass لازم ينفذها بطريقته. كل <code>clone()</code> يرجع نسخة من نفس النوع.',
        ...
        methods: [
          {
            ...
            purpose: '⭐⭐⭐ الـ COPY CONSTRUCTOR - الجوهرة الذهبية في Prototype. يأخذ Car آخر وينسخ كل قيمه. لاحظ: <code>super(target.getMake(), ...)</code> لازم تستدعي copy constructor الأب أو تنسخ كل properties.',
          ...
          },
          {
            ...
            purpose: 'ينفذ <code>clone()</code> عبر استدعاء الـ copy constructor مع <code>this</code>. لاحظ: <code>this</code> تشير للـ Car الحالي اللي بيتنسخ.',
        ...
        methods: [
          {
            ...
            purpose: 'الـ constructor يبني مجموعة prototypes جاهزة ويخزنها في الـ <code>HashMap</code>.',
          ...
          },
          {
            ...
            purpose: '⭐ النقطة المهمة: يرجع <code>cache.get(key).clone()</code> وليس <code>cache.get(key)</code>! لأننا لا نبي نعطي الأصل، نبي نسخة منه.',
