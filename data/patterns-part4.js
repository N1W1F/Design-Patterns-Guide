      ...
      },
      {
        ...
        methods: [
          ...
          },
          {
            ...
            purpose: 'يبلغ كل الـ observers بالتحديث الجديد. هذا اللي يفعّل <code>update()</code> عند كل واحد.',
        ...
        methods: [
          {
            ...
            purpose: '⭐ القائمة اللي تخزن كل المشتركين. <code>ArrayList</code> مرنة — تكبر وتصغر تلقائياً.',
            code: 'private List<Observer> observers = new ArrayList<>();'
          },
          {
            name: 'public void subscribe(Observer o)',
            purpose: 'يضيف observer للقائمة. <code>observers.add(o)</code> — سطر واحد فقط.',
            code: '@Override\npublic void subscribe(Observer o) {\n    observers.add(o);\n}'
          },
          {
            name: 'public void notifyUpdate(String m)',
            purpose: '⭐⭐⭐ القلب الحقيقي. يلف على كل الـ observers ويستدعي <code>update()</code> عند كل واحد.',
    ...
    public void postTweet(String tweet) {
        if (tweet.contains(keyword)) {
            ...
            checks: [
              ...
              { type: 'contains', value: 's.update', msg: 'استدعي update على الـ subscriber' }
            ]
          }
        ]
      }
