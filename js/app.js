  ...
  const flowHTML=flow.length?`
    <div class="flow-container" style="margin-top:1.25rem;">
      <div class="flow-title">
        <div class="uml-section-title" style="margin:0;">${t('howWorks')}</div>
        <div class="flow-controls">
          <button class="btn btn-outline btn-sm" id="flow-prev">←</button>
          <button class="btn btn-primary btn-sm" id="flow-play">${t('play')}</button>
          <button class="btn btn-outline btn-sm" id="flow-next">→</button>
          <button class="btn btn-ghost btn-sm" id="flow-reset">↺</button>
        </div>
      </div>
      <div class="flow-steps" id="flow-steps">
        ${flow.map((s,i)=>{
          ...
          return`<div class="flow-step ${i===0?'active':''}" data-step="${i}">
